...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cardJs = __webpack_require__(3);
	...
	var init = function init() {
		...
		try {
			for (var _iterator = cardSuits[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
				var s = _step.value;
				...
				try {
					for (var _iterator2 = cardVals[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
						var i = _step2.value;

						deck.push(new _cardJs2["default"](s, i));
					}
				} catch (err) {
	...
	*******************/
	...
	var printDeck = function printDeck(d) {
		return console.log(d.reduce(function (a, b) {
			return a.toString() + "," + b.toString();
		}));
	};
	// getVal() Returns the total value of all the cards in a player's hand
	var getVal = function getVal(arr) {
		return arr.reduce(function (a, b) {
			return a + b.getPoints(a);
		}, 0);
	};
	var discardHand = function discardHand(deck, hand) {
		return deck.push.apply(deck, hand);
	};
	var drawCard = function drawCard(deck, player) {
		var c = deck.pop();
		hands[player].push(c);
		deckClick(player);
	...
	var bust = function bust(player) {
		return victory(Object.keys(hands)[2 - player[1]]);
	};

	var calculate = function calculate(player) {
		var total = getVal(hands[player]);
		soft = false;
	...
	var hit = function hit(player) {
		if (!buttonActive.hit) {
			return;
		}
		var c = drawCard(deck, player);
		aces[player] += c.val === 'A';
	...
	var hitClick = function hitClick(e) {
		return hit("p1");
	};

	var hitOrNot = function hitOrNot() {
		return calculate("p2") <= 16 + soft;
	};
	...
	var createDiv = function createDiv(css, html) {
	...
	*************/
	...
	var createCard = function createCard(card, player) {
		var val = card.val;
		var suit = card.suit;
	...
	*******************/
	...
	var deckClick = function deckClick(player) {
		var slot = 0;
		var animation = "";
		if (player === 'p1') {
...
/***/ function(module, exports) {
	...
	var Card = (function () {
		...
		_createClass(Card, [{
			...
			key: "getPoints",
			value: function getPoints(total) {
				if (this.val === "A") {
					return 1;
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/jpg;base64,bW9kdWxlLmV4cG9ydHMgPSBfX3dlYnBhY2tfcHVibGljX3BhdGhfXyArICJiODAxZmIzMGIwNWI5MjIzYzc0YWY3MjdlYWM3NmM0Zi5qcGci"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "b801fb30b05b9223c74af727eac76c4f.jpg"
